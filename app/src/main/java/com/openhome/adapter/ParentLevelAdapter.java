...
public class ParentLevelAdapter extends BaseExpandableListAdapter {
    ...
    public ParentLevelAdapter(Context mContext, List<String> mListDataHeader, List<Hazards> selectedHazardsList) {
        ...
        for (int i = 0; i < parentCount; i++) {
            ...
            switch (content) {
                case "Indoor Hazards":
                    ...
                    break;
                default:
                    mItemHeaders = mContext.getResources().getStringArray(R.array.none);
            }
    ...
    public View getChildView(int groupPosition, int childPosition,
        ...
        secondLevelExpListView.setAdapter(new SecondLevelAdapter(this.mContext, mListData_SecondLevel_Map.get(parentNode), mListData_ThirdLevel_Map, selectedHazardsList));
